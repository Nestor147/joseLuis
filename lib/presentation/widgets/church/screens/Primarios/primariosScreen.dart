...
class _PrimariosScreenState extends State<PrimariosScreen> {
 List listResourcesForCuna = [
   // ["Resumen Escuela Sabática", "assets/leccion.png", '/leccion'],
    ...
    ["Multimedia","Audios y Videos Escuela Sabática", "assets/multimedia.png", '/multimediaPrimarios',Icon(Icons.video_call_outlined,color: Colors.white)],
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Primarios",style: TextStyle(color: Colors.white),),
