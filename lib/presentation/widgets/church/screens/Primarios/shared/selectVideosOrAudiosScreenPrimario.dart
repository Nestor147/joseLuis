...
class SelectVideosOrAudioScreenPrimarios extends StatefulWidget {
  // final Multimedia multimedia;
  const SelectVideosOrAudioScreenPrimarios({super.key});

  @override
  State<SelectVideosOrAudioScreenPrimarios> createState() => _SelectVideosOrAudioScreenPrimariosState();
}

class _SelectVideosOrAudioScreenPrimariosState extends State<SelectVideosOrAudioScreenPrimarios> {
  @override
        ...
        child: Center(
          child: Column(
            ...
            children: [
              GestureDetector(
                onTap: (){
                  context.push('/multimediVideoPrimarios');
                },
                child: Container(
                  width: 200,
                  height: 200,
              ...
              GestureDetector(
                onTap: (){
                  context.push('/multimediaAudioPrimarios');
                },
                child: Container(
                  width: 200,
                  height: 200,
