...
class LeccionMaestrosScreenPrimarios extends StatefulWidget {
  @override
  _LeccionMaestrosScreenPrimariosState createState() => _LeccionMaestrosScreenPrimariosState();
}

class _LeccionMaestrosScreenPrimariosState extends State<LeccionMaestrosScreenPrimarios> {
 @override
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView.builder(
          itemCount: leccionesPrimarios.length,
          itemBuilder: (context, index) {
            return Padding(
              ...
              child: ListTile(
                ...
                title: Text(leccionesPrimarios[index].name,style: TextStyle(color: Colors.white),),
                 trailing: Icon(Icons.arrow_forward_ios,color: Colors.white,),
                 contentPadding: EdgeInsets.symmetric(horizontal: 16, vertical: 8),
                onTap: () {
                  context.push('/pdfviewer', extra: leccionesPrimarios[index]);
                },
