...
class MisioneroScreenInfante extends StatefulWidget {
  const MisioneroScreenInfante({super.key});

  @override
  State<MisioneroScreenInfante> createState() => _MisioneroScreenInfanteState();
}

class _MisioneroScreenInfanteState extends State<MisioneroScreenInfante> {
  @override
