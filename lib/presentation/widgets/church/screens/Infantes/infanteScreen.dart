...
class _InfanteScreenState extends State<InfanteScreen> {
 List listResourcesForCuna = [
   // ["Resumen Escuela Sabática", "assets/leccion.png", '/leccion'],
    ...
    ["Multimedia","Audios y Videos Escuela Sabática", "assets/multimedia.png", '/multimediaInfante',Icon(Icons.video_call_outlined,color: Colors.white)],
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Infantes",style: TextStyle(color: Colors.white),),
