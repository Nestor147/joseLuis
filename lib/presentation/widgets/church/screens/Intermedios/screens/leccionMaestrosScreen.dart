...
class LeccionMaestrosScreenIntermedio extends StatefulWidget {
  @override
  _LeccionMaestrosScreenIntermedioState createState() => _LeccionMaestrosScreenIntermedioState();
}

class _LeccionMaestrosScreenIntermedioState extends State<LeccionMaestrosScreenIntermedio> {
 @override
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView.builder(
          itemCount: interLeccionesIntermedios.length,
          itemBuilder: (context, index) {
            return Padding(
              ...
              child: ListTile(
                ...
                title: Text(interLeccionesIntermedios[index].name,style: TextStyle(color: Colors.white),),
                 trailing: Icon(Icons.arrow_forward_ios,color: Colors.white,),
                 contentPadding: EdgeInsets.symmetric(horizontal: 16, vertical: 8),
                onTap: () {
                  context.push('/pdfviewer', extra: interLeccionesIntermedios[index]);
                },
