...
class MisioneroScreenIntermedio extends StatefulWidget {
  const MisioneroScreenIntermedio({super.key});

  @override
  State<MisioneroScreenIntermedio> createState() => _MisioneroScreenIntermedioState();
}

class _MisioneroScreenIntermedioState extends State<MisioneroScreenIntermedio> {
  @override
