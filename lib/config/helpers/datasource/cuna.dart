...
List<Content> leccionesAlumnos = [
 ...
 Content(
    ...
    Content(
      id: 43,
      name: 'Clase CUNA',
      content: 'https://www.youtube.com/watch?v=FJqFIdduXW0',
      contentType: ContentType.Video
    ),
    Content(
      id: 43,
      name: 'Dios hizo mi mundo',
      content: 'https://www.youtube.com/watch?v=ks64kCG7NFw',
      contentType: ContentType.Video
    ),
    Content(
      id: 43,
      name: 'Panes y peces',
      content: 'https://www.youtube.com/watch?v=OVnvFEMpXMU',
      contentType: ContentType.Video
    )
  ];
